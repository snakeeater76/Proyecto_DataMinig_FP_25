...
#En el excel se muestran las reglas para su interpretacion.
...
```{r}
#Aplicacion del algoritmo FPGrowht
#IMPORTS
library(arules)
library(fim4r)
library(readxl)
...
#En el excel se estearan revisando e interpretando las relgas obtenidas
